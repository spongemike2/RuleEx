namespace RuleEx2025
{
	partial class MailReadRibbon : Microsoft.Office.Tools.Ribbon.RibbonBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Description = "Show the path to the folder this item is in";
			this.button1.Label = "Show Folder Path";
			this.button1.Name = "button1";
			this.button1.OfficeImageId = "Folder";
			...
			this.Load += new Microsoft.Office.Tools.Ribbon.RibbonUIEventHandler(this.MailReadRibbon_Load);
